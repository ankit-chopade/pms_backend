...
public class AppointmentServiceImpl implements AppointmentServiceInteface {
	...
	@Override
	public List<PatientAppointmentDto> getAppointmentToPhysician(Long physicianId, LocalDate startDate,
			LocalDate endDate) {
...
//						
	...
	@Override
	public List<PatientAppointmentDto> getAppointmentsByDateAndPhysiciantId(String customDate, Long physicianId) {
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date date = null;
		try {
			date = formatter.parse(customDate);
