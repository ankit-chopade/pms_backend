	...
	public void addUserInKeyclock(UserDto dto, String password) {
		...
		try {
			...
			if(dto.getRoleId()==3) {
				 ...
				 * Physician
				 */
				roleParam.put("id", "eed1bd69-e9c3-4daf-b492-01afc6417989");
				 ...
				 * Nurse
				 */
				roleParam.put("id", "6c42a59a-afbf-44a4-baae-5c61c4e4bc1c");
				 ...
				 * Admin
				 */
				roleParam.put("id", "628fd4bc-31ad-427f-9997-ae00f7499f0a");
