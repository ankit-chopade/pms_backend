...
public class ScheduleController {
	...
	public ResponseEntity<ApiResponse> getPhysician() {
		return ResponseUtil.getResponse(HttpStatus.OK, "Physician Data Fetched Successful",
				schedulingService.getPhysician());
	}

	@PostMapping(PmsScheduleUrlConstants.URL_SAVE_APPOINTMENT)
	public ResponseEntity<ApiResponse> savePatientAppointment(@RequestBody PatientAppointmentDto patientAppointment)
			throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "Appointment Saved Successful",
				schedulingService.savePatientAppointment(patientAppointment));
	}
	...
	public ResponseEntity<ApiResponse> getPhysicianAppintments(@RequestBody IdDto idDto) throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "Appointment retrived Successful",
				schedulingService.getPhysicianAppintments(idDto.getId()));
	}

	@PostMapping(PmsScheduleUrlConstants.URL_EDIT_APPOINTMENT)
	public ResponseEntity<ApiResponse> editPatientAppointment(@RequestBody PatientAppointmentDto patientAppointment)
			throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "Appointment edited Successful",
				schedulingService.editPatientAppointment(patientAppointment));
	}
	...
	public ResponseEntity<ApiResponse> deletePhysicianAppointment(@RequestBody IdDto idDto) throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "Appointment deleted Successfully",
				schedulingService.deletePhysicianAppointment(idDto.getId()));
	}

	@PostMapping(PmsScheduleUrlConstants.URL_EDIT_HISTORY)
	public ResponseEntity<ApiResponse> saveEditHistory(@RequestBody EditHistorySaveDto editHistoryEntity)
			throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.CREATED, "History saved Successful",
				schedulingService.saveEditHistory(editHistoryEntity));
	}
	...
	public ResponseEntity<ApiResponse> getEditHistory(@RequestBody IdDto idDto) throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "History retrived Successful",
				schedulingService.getEditHistory(idDto.getId()));
	}

	@GetMapping(PmsScheduleUrlConstants.URL_GET_PATIENTS)
	public ResponseEntity<ApiResponse> getPatient() {
		return ResponseUtil.getResponse(HttpStatus.OK, "Patient Data Fetched Successful",
				schedulingService.getPatient());
	}
	...
	public ResponseEntity<ApiResponse> getPatientAppintments(@RequestBody IdDto idDto) throws CustomException {
		return ResponseUtil.getResponse(HttpStatus.OK, "Appointment retrived Successful",
				schedulingService.getPatientAppintments(idDto.getId()));
	}
}
